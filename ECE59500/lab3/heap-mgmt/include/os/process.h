...
typedef struct PCB {
  ...
  uint32	pagetable[((MEM_MAX_VIRTUAL_ADDRESS)>>MEM_L1FIELD_FIRST_BITNUM)+1];
  BuddyNode heap_trees[MEM_MAX_HEAP_NODES+1];
...
//---------------------------------------------------------
#define PROCESS_NUMPAGES_USERCODE_GLOBALDATA 4
