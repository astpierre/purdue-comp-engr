...
public class StateFactory {
   ...
   private static String[ ] classes = {"AddState", "CVCVState", "EofState", 
                                       "ErrorState", "InitState", "VCVState", "CVState", "VState", "Ld0State", "AddiState", "PrintState", "ExitState", "StoreState", "CVCVCVState", "VCVCVState"};

   // used to decode command names to the corresponding class name
   private static String[ ] commands = {"add", "CVCVState", "EofState", 
                                        "ErrorState", "InitState", "VCVState", "CVState", "VState", "ld0", "addi", "print", "exit", "store", "CVCVCVState", "VCVCVState"};
